        ...
        <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-xl my-10 border border-gray-200">
            ...
            <div className="flex gap-3 mb-5">
                ...
                <span className={`px-4 py-1 rounded-full text-sm font-semibold  
                    ${post.status === "ongoing" ? "bg-yellow-100 text-yellow-700" : "bg-green-100 text-green-700"}
                `}>
                    {post.status}
                </span>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 text-lg text-gray-700 mb-6">
                ...
                <p className="flex items-center gap-2">
                    ...
                    <span><strong>Budget:</strong> ৳{post.amount}</span>
                </p>
                ...
                <p className="flex items-center gap-2 md:col-span-2">
                    ...
                    <span><strong>Reported By:</strong> {post.email}</span>
                </p>
            </div>
