...
const AddIssue = () => {
    ...
    const onSubmit = async (data) => {
        ...
        const res = await axios.post("http://localhost:5000/issue", issueData);
    ...
    return (
        <div className="max-w-xl mx-auto p-6 mt-10 mb-10 bg-white shadow rounded-lg">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="">
                    <select {...register("category")} className="w-full text-left px-4 pr-2 py-2 border  bg-white text-gray-800 border-gray-300 shadow-sm rounded-full hover:bg-gray-50 focus:outline-none">
